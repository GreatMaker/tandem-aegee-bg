...
include("../../charts/class/pData.class.php");
include("../../charts/class/pDraw.class.php");
include("../../charts/class/pPie.class.php");
include("../../charts/class/pImage.class.php");
include('../../model/db_base_class.php');
...
/* Create and populate the pData object */
 ...
 $myPicture->setFontProperties(array("FontName"=>"../../charts/fonts/Silkscreen.ttf","FontSize"=>6));
 $myPicture->drawText(10,13,"pPie - Draw 3D pie charts",array("R"=>255,"G"=>255,"B"=>255));

 /* Set the default font properties */ 
 $myPicture->setFontProperties(array("FontName"=>"../../charts/fonts/Forgotte.ttf","FontSize"=>10,"R"=>80,"G"=>80,"B"=>80));
 ...
 /* Write the legend */
 $myPicture->setFontProperties(array("FontName"=>"../../charts/fonts/pf_arma_five.ttf","FontSize"=>6));
 ...
 $myPicture->setFontProperties(array("FontName"=>"../../charts/fonts/Silkscreen.ttf","FontSize"=>6,"R"=>255,"G"=>255,"B"=>255));
